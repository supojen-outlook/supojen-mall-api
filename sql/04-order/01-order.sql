...
INSERT INTO orders (id, order_number, user_id, status, total_amount, discount_amount, tax_amount, shipping_amount) VALUES
    (1, 'ORD-20240301-001', 1001, 'created', 2990, 0, 149, 60),
    (2, 'ORD-20240301-002', 1001, 'paid', 5800, 500, 265, 0),
    (3, 'ORD-20240302-001', 1001, 'shipped', 3200, 0, 160, 120);
